...
<div class="menubg flt">
	<ul class="menu flt">
        <li class="current_page_item"><a href="#" title="Crear Documento">Crear Nuevo Documento</a></li>
        <li class=""><a href="listado_doc.php" title="Editar Documento">Editar Documento</a></li>
        <li class=""><a href="configura.php" title="Volver Al inicio">Volver</a></li>
      
	</ul>	
</div>
<div class="fondo_doc"></div>
<form action="add_doc.php" name="datos" id="datos" method="post">

<table border="0" class="tbl_imp">
  <tr>
    <td>Nombre Documento:</td>
    <td>
      <input name="nombre_doc" type="text" id="nombre_doc" size="30" maxlength="30"  class="textbox"/>
    </td>
  </tr>
  <tr>
