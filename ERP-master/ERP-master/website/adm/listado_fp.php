...
<html>
<head>
<title>Listado Formas de Pago</title>
<?php
$consulta_doc=mysql_query("select * from forma_pago where estado='1' order by codigo_f_pago asc",$Db);
?>
...
<div class="menubg flt">
	<ul class="menu flt">
        <li class=""><a href="conf_fp.php" title="Crear Forma de Pago">Nueva Forma de Pago</a></li>
...
<td> <a href="edita_fp.php?id=<?php echo $row[0]?>"> <img src="../img/bedit.png" border="0" title="Editar Documento"> </a></td>
</tr>
<?php
}
?>
