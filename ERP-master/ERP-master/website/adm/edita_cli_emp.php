...
$con_cli=mysql_query("SELECT * FROM clientes WHERE RUT='$rut_c' AND TIPO_CLI='2'",$Db);
...
<div class="menubg flt">
	<ul class="menu flt">
		...
		<li class=""><a href="cliente_emp.php" title="Volver al Inicio">Volver</a></li>
	</ul>	
</div>
<div class="fondo_clte"> </div>
<form id="datos" name="datos" method="post" action="update_cli_emp.php">
<table width="100%" border="0" class="tbl_clte" bordercolor="#FFFFFF">
  <tr>
    <td>Rut</td>
    <td>
      <input name="rut_emp" type="text" id="rut_emp" readonly size="10" maxlength="8"  value="<?php echo $rut_c; ?>"/>
      <input name="dv_emp" type="text" id="dv_clte"  readonly="readonly" size="1"  value="<?php echo $dv_c; ?>" maxlength="1" /></td>
    <td>Nombre Fantasia:</td>
    <td><input name="fantasia" type="text" id="fantasia" size="20" maxlength="20" value="<?php echo $n1_c; ?>" /></td>
  </tr>
  <tr>
    <td>Razon Social:</td>
    <td><input name="razonsoc" type="text" id="razonsoc" size="40" maxlength="40" value="<?php echo $n2_c; ?>" /></td>
    <td>Giro:</td>
    <td><input name="giro" type="text" id="giro" size="40" maxlength="40"  value="<?php echo $a1_c; ?>"/></td>
    </tr>
  <tr>
    <td>Contacto:</td>
    <td><input name="contacto" type="text" id="contacto" size="40" maxlength="40" value="<?php echo $a2_c; ?>" /></td>
    <td>Telefono</td>
    <td><input name="fono_emp" type="text" id="fono_emp" size="10" maxlength="9" value="<?php echo $tel_c; ?>" /></td>
    </tr>
  <tr>
    <td>Region</td>
  ...
  <tr>
    <td>Direccion</td>
     <td><input  name="dire_emp" type="text" size="30" value="<?php echo $d_c; ?>"/>   </td>
    <td>Estado:</td>
